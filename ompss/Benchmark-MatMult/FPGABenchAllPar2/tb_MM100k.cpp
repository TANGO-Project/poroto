...
const char* name_file= "../__ExecStats/benchCPU_FPGA_2Par.csv";
int main() {
...
//{ 
	...
	#pragma omp target device(smp) 
        #pragma omp task in(A_1,B_1,A_2,B_2) inout(c_expected_tab,iter_cpu,flag,time_top,time_end,time_cpu,iter_fpga,C_2,time_fpga)
	{
